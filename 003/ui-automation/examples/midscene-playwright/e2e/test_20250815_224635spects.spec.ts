...
test.describe("问卷填写测试", () => {
  ...
  test("完整填写问卷并提交", async ({
    ...
    await aiTap('多选题中"时尚有趣"选项');
    await aiTap('多选题中"实体店难以买到"选项');
    await aiTap('"下一题"或"继续"按钮');
    await aiWaitFor("下一题加载完成");

    // 4. 主要购买【多选】：勾选"电子产品"、"书籍"
    await aiScroll({ direction: 'down', scrollType: 'once', distance: 100 }, '多选题区域');
    await aiTap('多选题中"电子产品"选项');
    await aiTap('多选题中"书籍"选项');
    await aiTap('"下一题"或"继续"按钮');
    await aiWaitFor("下一题加载完成");
    ...
    await aiTap('促销选择中"打折"选项');
    await aiTap('促销选择中"赠送优惠券"选项');
    await aiTap('"下一题"或"继续"按钮');
    await aiWaitFor("下一题加载完成");
